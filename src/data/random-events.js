const RANDOM_EVENTS=[
 ...
 {key:"tutoring",title:"不可不品鉴的一环",text:"家长提到附近有个补习班，最近不少同学都在考虑。",choices:[
  ["先询问试课 · 80元","你决定先看看老师是否适合自己。",()=>{if(!spendCash(80,"一次试课")){gainExperience("academic",1,"领取免费试听资料");return "预算暂时不够，你没有付费。老师给了免费资料，你准备先从这里开始。";}gainExperience("academic",3,"试课练习");changeResource("energy",-7);return "付费并没有直接变成成绩。你带回了更具体的练习，接下来仍然需要自己完成。";}],
  ["先不报，用学校的免费答疑","你先靠自己的节奏摸索。",()=>{gainExperience("academic",2,"课后答疑");changeResource("energy",-9);return "你留下来多问了几道题，没花钱，但用掉了原本休息的时间。";}]
 ]},
 {key:"home168",title:"丰川家的黑暗！？",text:"同学把群里夸张的破产梗转给你。真正发生的事情没有那么戏剧化：家里最近需要周转，接下来三个月的零花钱会减半。",choices:[
  ["和家里重新列预算","你把非必要消费先划掉。",()=>{S.flags.familyShockUntil=S.calendarIndex+3;changeResource("stress",-3);return "背景没有被一笔抹掉，但接下来三个月可用的钱确实变少了。你决定暂缓几项付费活动。";}],
  ["把兴趣活动搬回学校","你开始寻找免费的场地。",()=>{S.flags.familyShockUntil=S.calendarIndex+3;addInterest("校园资源");gainExperience("creativity",1,"重新安排活动");return "你没有放弃兴趣，只是开始借学校的场地和器材。";}]
 ]}
];
