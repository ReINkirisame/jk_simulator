...
当前发行版为0.6.2。下面0.2～0.4的操作示例保留作历史参考；更新本版时使用新的独立分支，复制源码包中的项目内容，执行 `npm test` 后再审阅合并。当前版本已支持三年基础流程、生活习惯、条件传闻、毕业档案、多特质成长和角色合成，规则以 README 与 RELEASE_0.6.0.md 为准。
